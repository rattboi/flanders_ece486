...
The victim cache was given second highest priority in terms of space allocation.  Our goal was to maximize associativity while still leaving some space remaining for the return address stack.\\\\ 
After deciding to use the 64x8 main cache, we had 542 bytes of space remaining.
